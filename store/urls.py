...
urlpatterns = [
    ...
    path('remove-favorite/<int:product_id>/', views.remove_favorite, name="remove-favorite"),
    ...
    path('<slug:slug>/', views.category_products, name="category-products"), #No poner debajo de este porque se come las demas urls (busca antes esta url). He estado mucho tiempo pa darme cuenta de que search tiene que ir arriba.
